...
verbes_3 = {
    ...
    "couper": ("cut", "cut", "cut"),
    "distribuer, traiter (un sujet)": ("deal (with)", "dealt (with)", "dealt (with)"),
    ...
    "apprendre, enseigner": ("teach", "taught", "taught"),
    ...
    "congeler, geler": ("freeze", "froze", "frozen"),
    "(faire) pousser, grandir": ("grow", "grew", "grown"),
    "payer": ("pay", "paid", "paid"),
    "vendre": ("sell", "sold", "sold"),
    "verser (des larmes)": ("shed", "shed", "shed"),
    "sentir (odeur)": ("smell", "smelt", "smelt"),
    "dépenser": ("spend", "spent", "spent"),
    "renverser": ("spill", "spilt", "spilt"),
    "gâcher": ("spoil", "spoilt / spoiled", "spoilt / spoiled"),
}

input_choice = input("Choisis l'eval (1, 2 ou 3): ")
if input_choice == "1":
    verbes = verbes_1
elif input_choice == "2":
    verbes = verbes_2
